...
/**
 * Created by Salman Ishaq on 20/11/2015.
 * Internet help: http://www.learn2crack.com/2014/04/android-login-registration-nodejs-client.html/2
 */
...
public class ServerRequestPost {
    static InputStream is = null;
    static JSONObject jObj = null;
    static String json = "";
    private Object mLock = new Object();
    private CookieStore mCookie = null;
    List<Cookie> mcook = null;
    Cookie cookie;
    SharedPreferences pref;

    public ServerRequestPost() {
    ...
    private class Request extends AsyncTask<Params, String, JSONObject> {
        ...
        protected JSONObject doInBackground(Params... args) {
            ...
            ServerRequestPost request = new ServerRequestPost();
