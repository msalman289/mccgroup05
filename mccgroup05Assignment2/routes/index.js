...
module.exports = function(passport){
  ...
  // Index Page  i.e. http://localhost:3000/
  router.get('/', function(req, res) {
    res.render('index', {});
  });
  
  // Search Page i.e. http://localhost:3000/search
  ...
  // Register Page i.e. http://localhost:3000/register
  ...
  // Home Page i.e. http://localhost:3000/home
