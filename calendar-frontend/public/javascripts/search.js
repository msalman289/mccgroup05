...
$(document).ready(function() {
	$.getJSON( '/userinfo', function( data ) {
		...
		$('#container').html('<div><div><img class="center-block" src="http://130.233.42.186:8080/images/calendar365.png" style="align-center"/></div></div>');
...
function searchEvent(event) {
	...
	$.ajax({
		type: 'GET',
		data: searchEvent,
		url: 'http://130.233.42.186:8080/searchevent',
		dataType: 'JSON'
